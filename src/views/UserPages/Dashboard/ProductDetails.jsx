                                          ...
                                          {(likesUpdate, { data }) => (
                                            ...
                                            >
                                                ...
                                                <svg
                                                  width={40}
                                                  height={40}
                                                  fill={toggled ? 'limegreen' : 'none'}
                                                  xmlns="http://www.w3.org/2000/svg"
                                                
                                                >
                                                  <path
                                                    d="M34.733 7.683a9.167 9.167 0 0 0-12.966 0L20 9.45l-1.767-1.767A9.169 9.169 0 0 0 5.268 20.65l1.766 1.767L20 35.383l12.967-12.966 1.767-1.767a9.167 9.167 0 0 0 0-12.967v0Z"
                                                    stroke={toggled ? 'limegreen' : '#212529'}
                                                    strokeWidth={3}
                                                    strokeLinecap="round"
                                        ...
                                        <li>
                                          ...
                                          >
                                            <span title={t("Productdetails._share")}>
                                              ...
                                              <ShareIcon style={{width:'40px !important',height:'40px !important'}} width={40} height={40} />
                                            </span>
                                            <span className="save-like">
                                              {" "}
                    ...
                    <div className="nn_map_details">
                      <div className="nn_mapsloc">
                        ...
                        <span>
                          ...
                          ) : getProductMount.location && `${getProductMount.location.address ? getProductMount.location.address + ", ":""}${getProductMount.location.city}, ${getProductMount.location.state}, ${getProductMount.location.country}`}{" "}
                        </span>
                      </div>
                      <GridContainer>
