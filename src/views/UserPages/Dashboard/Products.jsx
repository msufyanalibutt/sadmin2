                      ...
                      > 
                        {allProducts.map((p, index) => {
                          ...
                          return (
                            <>
                              {(getCacheCategoryData === undefined || getCacheCategoryData === "") ? (
                                <div className= "proctn" key={index} style={{position:'relative'}}>

                                  {((p.instantBuy === true) && (!p.isFree) && (p.sellingStatus === "ForSale")) &&
                                  <p className="buy_now_btn" style={{position:'absolute',backgroundColor:'#00AFFF'}}>Buy</p>}
